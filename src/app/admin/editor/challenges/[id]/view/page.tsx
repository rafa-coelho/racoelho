    ...
    <div className="container mx-auto px-4 py-10">
      <div className="card-modern p-6 max-w-4xl mx-auto space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold">Visualizar Desafio</h1>
          <div className="flex gap-2">
            <Link href={`/admin/editor/challenges/${id}`} className="btn-primary px-3 py-1.5 text-sm">Editar</Link>
            <a href={`/listas/desafios/${rec.slug}`} target="_blank" rel="noopener" className="px-3 py-1.5 text-sm border rounded-md hover:bg-white/5">Ver público</a>
          </div>
        </div>
