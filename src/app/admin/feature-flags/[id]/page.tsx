  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="rounded-rc-card border border-rc-border-card bg-rc-surface p-5 md:p-8 max-w-3xl mx-auto">
        <h1 className="mb-6 text-[24px] font-semibold tracking-[-.02em] text-rc-ink md:text-[28px]">Editar Feature Flag</h1>
        ...
        <div className="space-y-6">
          ...
          {key === 'ads' ? (
            <div>
              <label className="mb-4 block font-mono text-[11px] uppercase tracking-[.08em] text-rc-ink-4">Configuração de Anúncios</label>
          ...
          <div className="flex gap-3 pt-5 border-t border-rc-border">
            <button
              onClick={onDelete}
              className="min-h-[44px] px-4 rounded-[10px] border border-rc-border-strong text-rc-red hover:border-rc-red flex items-center gap-2"
            >
