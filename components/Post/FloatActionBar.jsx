    ...
    return (
        <>
            <div className="fixed bottom-2 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white p-2 rounded-full shadow-lg flex items-center space-x-3 p-3 opacity-70">
                <button className="focus:outline-none hover:text-red-500 transition duration-150 hover:scale-125" aria-label="Like">
                ...
                <button className="focus:outline-none hover:text-yellow-500 transition duration-150 hover:scale-125" aria-label="Comment">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" />
                    </svg>
                </button>

                <button className="focus:outline-none hover:text-blue-500 transition duration-150 hover:scale-125" aria-label="Share">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="focus:outline-none hover:text-orange-500 transition duration-150 hover:scale-125" aria-label="Save">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
